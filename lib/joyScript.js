$(document).ready(function(){
    ...
    originalHeight = new Object(); //Contains the height of hidden objects

    //Saving some often used selectors to variables
    hidden = $('.hidden');  
    kategori = $('.kategori');
    formContainer = $('.formContainer');

    fadeOutTime = 200;
    fadeInTime = 400; //These two varibales determine animation speed
