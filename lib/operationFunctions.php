...
/**
 * Publish a piece of content, an entry on a page. Push it to the DB.
 */
function publishEntry($table){
...
/**
 * Update some part of of an existing page.
 */
...
/**
 * The following creates a whole new page.
 */
function createPage($table, $title){
  ...
  $sql = "INSERT INTO `pages` (`index`, `title`, `JStitle`)
            VALUES ('{$nextIndex}', '{$title}', '$JStitle');";
